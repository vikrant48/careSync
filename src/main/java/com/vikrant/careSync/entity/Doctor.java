...
@AllArgsConstructor
@Builder
@ToString(exclude = {"experiences", "educations", "certificates", "appointments", "feedbacks"})
@EqualsAndHashCode(exclude = {"experiences", "educations", "certificates", "appointments", "feedbacks"})
@Entity
@Table(name = "doctors")
