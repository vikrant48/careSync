...
public interface MedicalHistoryRepository extends JpaRepository<MedicalHistory, Long> {
    ...
    List<MedicalHistory> findByPatientIdAndVisitDateBetween(@Param("patientId") Long patientId, @Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
}