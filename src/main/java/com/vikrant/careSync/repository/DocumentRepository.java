...
public interface DocumentRepository extends JpaRepository<Document, Long> {
    ...
    List<Document> findByDoctorIdAndDocumentType(@Param("doctorId") Long doctorId, @Param("documentType") Document.DocumentType documentType);
    ...
    List<Document> findByPatientIdAndDocumentType(@Param("patientId") Long patientId, @Param("documentType") Document.DocumentType documentType);
